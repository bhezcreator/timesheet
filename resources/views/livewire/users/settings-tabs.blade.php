<div class="p-0">
    ...
    {{-- En-tête de la page --}}
    <div>
        <h1 class="text-2xl font-bold text-gray-900 tracking-tight">Paramètres du compte</h1>
    ...
    <div class="border-b border-gray-200">
        ...
        <div class="sm:hidden mb-4">
            ...
            <select
                ...
                class="block w-full rounded-xl border-gray-300 text-base focus:border-indigo-500 focus:ring-indigo-500 py-2.5 shadow-xs"
            >
    ...
    <div class="bg-white rounded-2xl border border-gray-100 p-6 shadow-xs min-h-[300px] transition-all duration-200">
        ...
        @if($activeTab === 'profile')
            <div class="space-y-4 animate-fade-in" wire:key="tab-content-profile">
                <h2 class="text-lg font-bold text-gray-900">Mon Profil professionnel</h2>
                <p class="text-sm text-gray-500">Mettez à jour vos coordonnées publiques et votre avatar d'identification.</p>
        ...
        @if($activeTab === 'security')
            <div class="space-y-4 animate-fade-in" wire:key="tab-content-security">
                <h2 class="text-lg font-bold text-gray-900">Sécurité du compte</h2>
                <p class="text-sm text-gray-500">Modifiez votre mot de passe et configurez l'authentification à deux facteurs.</p>
                {{-- Insérez votre formulaire de changement de mot de passe ici --}}
            </div>
        @endif
