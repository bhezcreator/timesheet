...
<a href="{{ route('register') }}"
class="bg-indigo-600 text-white px-7 py-3 rounded-xl font-semibold hover:bg-indigo-700">
...
<a href="#features"
class="border border-gray-300 px-7 py-3 rounded-xl font-semibold hover:bg-gray-100">
